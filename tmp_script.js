   ...
   ============================================================ */
            ...
            class Unit extends Entity {
                ...
                draw(ctx, cam, dt) {
                    ...
                    const wC =
                        this.state === "walk"
                            ? Math.sin(this.frame * 0.2 * (this.speed / 2))
                            : 0;
                    const aC =
                        this.state === "attack"
                            ? Math.sin(this.frame * 0.5)
                            : 0;
                    const breath =
                        this.state === "idle" || this.state === "walk"
                            ? Math.sin(this.frame * 0.1) * 2
                            : 0;
                    ...
                    if (this.flying)
                        ctx.translate(0, -70 + Math.sin(this.frame * 0.1) * 12);
                    ...
                    if (this.vis !== "horse") {
                        ctx.beginPath();
                        ctx.moveTo(0, bY + 22);
                        ctx.lineTo(-7 * wC, bY + 32 - Math.abs(wC) * 3);
                        ctx.lineTo(-12 * wC, 0);
                        ctx.stroke();
                    }
                    ...
                    if (
                        ...
                        ctx.beginPath();
                        ctx.moveTo(-4, bY);
                        const capeSway = Math.sin(this.frame * 0.1) * 4;
                    ...
                    ctx.lineWidth = 2.5;
                    ctx.beginPath();
                    ctx.arc(0, bY - 10, 8, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.stroke();
                    ctx.fillStyle = "#fff";
                    ctx.beginPath();
                    ctx.arc(4, bY - 12, 2.5, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.fillStyle = "#000";
                    ctx.beginPath();
                    ctx.arc(4.5, bY - 12, 1.2, 0, Math.PI * 2);
                    ctx.fill();
                    ...
                    const armX =
                        this.state === "attack" ? 14 + Math.max(0, aC) * 12 : 6;
                    ...
                    if (this.vis === "bow" || this.vis === "crossbow") {
                        ...
                        if (this.vis === "bow") {
                            ctx.beginPath();
                            ctx.arc(16, bY + 6, 14, -Math.PI / 2, Math.PI / 2);
                            ctx.stroke();
                        } else {
                            ctx.beginPath();
                            ctx.moveTo(6, bY + 6);
                        ...
                        ctx.beginPath();
                        ctx.moveTo(0, bY + 6);
                        ctx.lineTo(aC < 0 ? -6 : 6, bY + 6);
                        ctx.stroke();
                    } else if (this.vis === "staff" || this.vis === "mage") {
                        ctx.strokeStyle =
                            this.team === TEAMS.PLAYER ? "#3b82f6" : "#c084fc";
                        ctx.lineWidth = 4;
                        ctx.beginPath();
                        ctx.moveTo(12, 0);
                        ctx.lineTo(18, bY - 25);
                        ...
                        if (
                            this.vis === "sword" ||
                            this.vis === "sword_shield"
                        ) {
                            ctx.beginPath();
                            ctx.moveTo(armX, bY - 6);
                            ctx.lineTo(armX + 18, bY - 25);
                            ctx.stroke();
                            ctx.lineWidth = 2;
                            ctx.beginPath();
                            ctx.moveTo(armX + 2, bY - 10);
                            ctx.lineTo(armX + 8, bY - 4);
                            ctx.stroke();
                        } else if (this.vis === "spear") {
                            ctx.beginPath();
                            ctx.moveTo(armX - 12, bY);
                            ctx.lineTo(armX + 35, bY - 18);
                            ctx.stroke();
                            ...
                            ctx.beginPath();
                            ctx.moveTo(armX, bY - 6);
                            ctx.lineTo(armX + 18, bY - 28);
                            ctx.stroke();
                        } else if (this.vis === "dual") {
                            ctx.beginPath();
                            ctx.moveTo(armX, bY - 6);
                            ctx.lineTo(armX + 16, bY - 22);
                            ctx.stroke();
                            ctx.beginPath();
                            ctx.moveTo(bArmX, bY + 18);
                            ctx.lineTo(bArmX - 12, bY + 30);
                            ctx.stroke();
                        }

                        if (
                            this.vis === "sword_shield" ||
                            this.vis === "tower_shield"
                        ) {
                            ctx.fillStyle = "#475569";
                            ctx.strokeStyle = "#f1f5f9";
                            ctx.lineWidth = 2;
                            if (this.vis === "tower_shield") {
                                ctx.fillRect(8, bY - 18, 12, 42);
                                ctx.strokeRect(8, bY - 18, 12, 42);
                                ctx.fillStyle = this.col;
                                ctx.fillRect(12, bY - 6, 4, 18);
                            } else {
                                ctx.beginPath();
                                ctx.arc(8, bY + 6, 12, 0, Math.PI * 2);
                                ctx.fill();
                                ctx.stroke();
                                ctx.fillStyle = this.col;
                                ctx.beginPath();
                                ctx.arc(8, bY + 6, 3, 0, Math.PI * 2);
                                ctx.fill();
                            }
                        }
                    }
            ...
            class Game {
                ...
                draw(dt) {
                    ...
                    if (dP < 0) {
                        ...
                        for (let i = 0; i < 80; i++) {
                            ctx.globalAlpha =
                                0.3 + Math.sin(this.dayT * 5 + i) * 0.4;
                            ctx.beginPath();
                            ctx.arc(
                                (i * 157) % w,
                                (i * 73) % (h / 2),
                    ...
                    const cY = h * 0.25 - dP * h * 0.25,
                        cX = w * 0.8 + Math.cos(this.dayT) * w * 0.2;
                    ctx.fillStyle = dP > 0 ? "#fde047" : "#e2e8f0";
                    ctx.shadowBlur = dP > 0 ? 50 : 30;
                    ctx.shadowColor = ctx.fillStyle;
                    ctx.beginPath();
                    ctx.arc(cX, cY, dP > 0 ? 40 : 30, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.shadowBlur = 0;
                    ...
                    for (let i = 0; i < 12; i++) {
                        ...
                        ctx.beginPath();
                        ctx.moveTo(mx, h);
                        ctx.lineTo(mx + 250, h - 220 - (i % 3) * 70);
                        ctx.lineTo(mx + 500, h);
                        ctx.fill();
                    }
                    ctx.fillStyle = dP > 0 ? "#0f172a" : "#020617";
                    for (let i = 0; i < 25; i++) {
                        const tx = ((i * 200 - cam.x * 0.3) % (w + 300)) - 150;
                        ctx.beginPath();
                        ctx.moveTo(tx, h);
                        ctx.lineTo(tx + 35, h - 120 - (i % 4) * 25);
                        ctx.lineTo(tx + 70, h);
                        ctx.fill();
                    }
